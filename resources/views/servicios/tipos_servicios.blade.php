...
@section('title', 'Tipos de Servicios - Hotel Project')
...
@section('content')
            ...
            <div class="col-sm-4" style="padding-top: 10px;">
                <div style="flex: 1; min-width: 20%; background-color: white; height: 250px;">
                    <div style="border-bottom: 2px solid white; padding: 12px; background-color: #222831;">
                        <h5 class="modal-title" style="font-size: 23px; color: white; text-align: center; margin: 0;" id="servicioModalLabel">Crear tipo de servicio</h5>
                    </div>
                    <div style="padding: 5%;">
                        <form id="tipoServicioForm" action="" method="POST">
                            @csrf
                            <input type="hidden" id="id" name="id">
                            <div class="mb-3">
                                <label for="tipo_servicio" class="form-label" style="font-weight: 500">Tipo de Servicio</label>
                                <input type="text" class="form-control border-thick" id="tipo_servicio" name="tipo_servicio" required>
                                <div id="tipo_servicio-error" class="text-danger"></div>
                            </div>
                        </form>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body" style="font-size: 17px">
                    ¿Estás seguro de que quieres cambiar el estado de este tipo de servicio?
                </div>
    ...
    <script>
        ...
        const insertTipoServicioRoute = '{{ route('insertTipoServicio') }}';
        const editTipoServicioRoute = '{{ route('editTipoServicio') }}';
        const changeStatusRoute = '{{ route('cambiarStatusTipoServicio') }}';
    </script>
    
    @vite('resources/js/tipos/tipo_servicio.js')
@endsection
