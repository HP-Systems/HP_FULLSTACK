                    ...
                    <div class="modal-body">
                        <form method="POST" action="{{ route('updateRoom', ['id' => $habitacion->id]) }}" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <div>
                                    <img src="{{ asset('images/' . $habitacion->imagen) }}" alt="Imagen actual" style="max-width: 200px;">
                                </div>
                                @endif
                                <br>
                            ...
                            <div class="mb-3">
                                ...
                                <select name="tipoID" class="form-select tipoHabitacionSelect">
                                    ...
                                    <option value="{{$tipoHabitacion->id}}" data-capacidad="{{$tipoHabitacion->capacidad}}" data-precio="{{$tipoHabitacion->precio_noche}}" data-descripcion="{{$tipoHabitacion->descripcion}}" @if($tipoHabitacion->id == $habitacion->tipoID) selected @endif>
                                        {{$tipoHabitacion->tipo}}
                                    </option>
                                    @endforeach
                                </select>
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('room.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="tipoID" class="form-select tipoHabitacionSelect">
                                @foreach ($tipoHabitaciones as $tipoHabitacion)
                                <option value="{{$tipoHabitacion->id}}" data-capacidad="{{$tipoHabitacion->capacidad}}" data-precio="{{$tipoHabitacion->precio_noche}}" data-descripcion="{{$tipoHabitacion->descripcion}}">
                                    {{$tipoHabitacion->tipo}}
                                </option>
                                @endforeach
                            </select>
